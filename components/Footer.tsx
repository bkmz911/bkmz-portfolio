...
export default function Footer() {
  ...
  return (
    <section id="contact" ref={containerRef} className="relative h-screen bg-[#111] text-white flex flex-col md:flex-row overflow-hidden border-t border-zinc-800">
      ...
      <div className="w-full md:w-1/2 h-[40vh] md:h-full relative overflow-hidden">
        <motion.div style={{ y: imageY }} className="absolute inset-[-20%] w-[140%] h-[140%]">
          <Image
            src="https://picsum.photos/seed/portrait14/1200/1600"
            alt="Lorian Hans Contact Portrait"
            fill
            className="object-cover filter grayscale contrast-[1.1] opacity-70"
      ...
      >
        ...
        <motion.div 
          ...
          className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-12 sm:gap-0 font-medium pb-8 md:pb-0"
        >
          <div className="flex flex-col gap-1 text-lg lg:text-[1.3rem] tracking-tight">
            <a href="tel:+11234567890" className="hover:text-zinc-400 transition-colors">+1 (123) 456-7890</a>
            <a href="mailto:lorianhans@gmail.com" className="hover:text-zinc-400 transition-colors">lorianhans@gmail.com</a>
          </div>
          ...
          <div className="flex gap-4 items-center">
             ...
             <a href="#" className="hover:text-zinc-400 transition-colors">
               <Twitter className="w-5 h-5 md:w-6 md:h-6" strokeWidth={1.5} />
             </a>
          </div>
        </motion.div>
      </motion.div>
