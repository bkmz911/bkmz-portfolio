    ...
    return (
        <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-[5px] p-[5px]">
                ...
                >
                    {/* Главная картинка: плавно растворяется */}
                    <Image
                        src={previous.img}
                        alt={previous.title}
                        fill
                    ...
                    {/* Hover картинка: плавно появляется */}
                    <Image
                    ...
                    {/* Градиент для читаемости текста (опционально, но полезно) */}
                    <div className="absolute inset-x-0 bottom-0 h-32 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none z-10" />
