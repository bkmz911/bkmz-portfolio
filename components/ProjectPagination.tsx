        ...
        <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-[5px] p-[5px]">
                ...
                >
                    ...
                    {/* Content Overlays */}
                    <div className="absolute inset-x-0 bottom-0 h-32 bg-gradient-to-t from-black/60 to-transparent opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-500 pointer-events-none z-10 will-change-opacity" />
                    <div className="absolute left-4 bottom-4 z-30 flex items-end opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-500 pointer-events-none will-change-opacity">
                        <h3 className="text-white text-xl md:text-2xl font-medium tracking-tight">
                            {previous.subtitle1}
                        </h3>
                    </div>
                    <div className="absolute right-4 bottom-4 z-30 flex items-end opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-500 text-right pointer-events-none will-change-opacity">
