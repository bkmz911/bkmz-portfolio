...
export default function Navbar({
    ...
    return (
        <motion.nav className="fixed top-0 left-0 w-full z-50 p-4 md:p-[20px] flex justify-between items-start pointer-events-none">
            ...
            <motion.div
                layout
                className="pointer-events-auto flex items-center bg-white text-[#111] rounded-full overflow-hidden border border-zinc-200"
            ...
            >
                        ...
                        >
                            <div className="flex items-center gap-6 pl-6 pr-2 font-medium text-sm md:text-base">
                                ...
                                <button
                                    ...
                                    className="hover:text-zinc-500 cursor-pointer transition-colors uppercase border-l border-zinc-300 pl-6 ml-2 font-semibold"
                                >
                                    {locale === "en" ? "RU" : "EN"}
                                </button>
                            </div>
                ...
                <button
                    onClick={toggleMenu}
                    className="relative cursor-pointer w-12 h-12 md:w-14 md:h-14 flex items-center justify-center hover:bg-gray-50 transition-colors flex-shrink-0 focus:outline-none"
