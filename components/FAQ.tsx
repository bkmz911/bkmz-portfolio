...
export default function FAQ() {
    ...
    return (
        <section
            id="faq"
            className="py-24 md:py-48 px-4 md:px-8 bg-white text-[#111]"
        >
                    ...
                    {faqs.map((faq, i) => {
                        ...
                        return (
                            ...
                            >
                                <button
                                    onClick={() => toggle(i)}
                                    className="w-full cursor-pointer flex justify-between items-center py-6 md:py-8 text-left focus:outline-none group"
                                >
                                    <span className="text-xl md:text-2xl font-medium">
                                        {t(`faqs.faq${i + 1}.question`)}
                                    </span>
                                    <motion.div
